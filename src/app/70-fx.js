...
// Расщепление «В ТРУХУ»: плотное облако пыли цвета предмета — ×2 частиц
// (спека владельца 2026-07), ТРИ фракции размеров (мелкая/средняя/крупная)
// и вершинный разброс оттенков — труха «разнообразнее».
// radial=true — плоский разлёт кольцом (пыль из-под лопастей миксера).
const DUST_FRACTIONS = [
  { n: 320, size: 0.045 }, // мука
  { n: 200, size: 0.07 },  // крошка
  { n: 120, size: 0.1 },   // крупные обломки
];
