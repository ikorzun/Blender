...
const Sound = (function(){
  ...
  const fxMap = {
    match(a){ // «буль»-арпеджио, выше и длиннее при большой группе.
      ...
      // ⛔ ЧЕГО СДЕЛАТЬ НЕЛЬЗЯ: round robin из присланного владельцем образца
      // требует НЕСКОЛЬКИХ дублей на материал, а у нас по ОДНОЙ записи. Появятся
      // дубли — включается одной строкой, как у `grind` (тот выбирает из трёх).
      ...
      // калибр типа (банан 1.4 против яблока 1.0), и разброс размеров уровня.
    ...
    crunch(n){ // «хруст» скола твёрдой пачки (brick/pirate/rock -> осколки).
