...
// ⚙️ Lx 0 — ВЫБОР ВЛАДЕЛЬЦА 2026-08-03 (крутил сам в ?matcap=1, прислал
// панель скриншотом со словами «забери эти параметры matcap»). Свет был
// сверху-СЛЕВА-спереди, стал сверху-ПО ЦЕНТРУ-спереди: блик садится на
// середину предмета, левый край перестал быть систематически ярче правого.
// ⚠️ SHARD_LIGHT в 70-fx ОБЯЗАН СОВПАДАТЬ (см. комментарий там): осколки и
// черепки чаши светятся запечённым тинтом по ЭТОМУ направлению, и расхождение
// дало бы кучу, освещённую иначе, чем её же обломки.
