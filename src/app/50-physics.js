...
const WALL_GAP = 0.12;
const WALL_SEG = 32;
// Верх ФИЗИЧЕСКИХ стен: пояс над кромкой стоит центром на FUNNEL.H + 2.0 с
// полувысотой 2.1, то есть кончается здесь. Выше — открытый воздух, и
// сравнивать там «выступ за стену» не с чем (см. maxWallExcess в 99-main).
const WALL_TOP_Y = 9.2 + 2.0 + 2.1;
