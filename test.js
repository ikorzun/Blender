  ...
  // проверяется через API (`level().shakes`), а показывает число DOM.
  {
    ...
    const снятьShake = () => стр.evaluate(() => {
      ...
      return { тег: b.tagName, ария: b.getAttribute('aria-label'),
               ...
               кисть: hr ? [Math.round(hr.left - r.left), Math.round(hr.top - r.top),
                            Math.round(hr.width), +hr.height.toFixed(2)] : null,
               бейджX: Math.round(lr.left - r.left), бейджY: Math.round(lr.top - r.top),
    ...
    expect(ш0.тег === 'BUTTON' && ш0.ария === null &&
           ...
           ш0.ширина === 80 && ш0.высота === 80 &&
           ш0.фон === 'rgba(0, 0, 0, 0)' && ш0.фонКартинка === 'none' &&
           ш0.позиция === 'relative' && ш0.события === 'auto',
      '⚠️⚠️ SHAKE — ИКОНКА-КИСТЬ 80×80 БЕЗ ПОДЛОЖКИ, А НЕ ТЁМНАЯ ПИЛЮЛЯ (' +
    ...
    expect(ш0.естьКисть && ш0.вьюбокс === '0 0 79.9997 72.7758' && ш0.pAR === null &&
           ш0.путей === 12 && ш0.кисть[0] === 0 && ш0.кисть[1] === 4 &&
           ш0.кисть[2] === 80 && Math.abs(ш0.кисть[3] - 72.7758) < 0.05 &&
           ш0.цвета['rgb(0, 0, 0)'] === 11 && ш0.цвета['rgb(255, 255, 255)'] === 1,
      '⚠️⚠️ КИСТЬ — ИНЛАЙНОВЫЙ SVG С ЖИВОЙ ГЕОМЕТРИЕЙ И БЕЗ МИНЫ DEV MODE (' +
    ...
    expect(ш0.бейджX === 33 && ш0.бейджY === 53 && ш0.бейджВ === 24 && ш0.бейджШ === 24 &&
           ...
           ш0.бейджX + ш0.бейджШ <= 80,
      '⚠️⚠️ ЛАЙМОВЫЙ БЕЙДЖ В ТОЧКЕ 33/53 ПО МАКЕТУ (' +
      ...
      '(«три цифры дают 73 < 80»), и без него ширина не ограничена сверху ничем');
    ...
    expect(ш0.своих > 0 && ш0.текст === String(ш0.своих) && ш0.класс === '' &&
           ...
           шAd.бейджШ > шAd.бейджВ && шAd.бейджX + шAd.бейджШ <= 80 &&
