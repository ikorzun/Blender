...
`;
  ...
  const cols = await (async () => {
    ...
    const r = { w380: await n(380), w381: await n(381), w430: await n(430), w600: await n(600),
                w700: await n(700), w799: await n(799), w389: await n(389), w393: await n(393) };
  ...
  expect(cols.w600 <= 4 && cols.w700 === 4 && cols.w799 === 4,
    '⚠️ КОЛЛЕКЦИЯ: на мобильном НЕ БОЛЬШЕ 4 столбцов (' + JSON.stringify(cols) + ')');
  // ⚠️ ЕГО ТЕЛЕФОН: 1080 ФИЗИЧЕСКИХ пикселей при плотности 2.75 = 393 CSS —
  // там обязаны быть 4 (жалоба «ширина 1080 px колонки 3, а не 4»). Полоса
  // 381-389 с тремя колонками сохранена: это ДРУГОЕ его число, в CSS-px.
  expect(cols.w393 === 4 && cols.w389 === 3,
    '⚠️ КОЛЛЕКЦИЯ: 393 CSS (=1080 физ.) -> 4, узкая полоса 381-389 -> 3 (' + JSON.stringify(cols) + ')');
