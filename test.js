...
`;
  ...
  // переключение УМЕР ВМЕСТЕ С МЕХАНИКОЙ, а не переписан: он стерёг то, чего
  // больше нет. Взамен два утверждения о НОВОМ правиле («стиль как у More,
  // ширина 560»).
  // ⚠️ Ширина проверяется С ОБЕИХ СТОРОН: только потолок был бы зелен и у
  // экрана шириной 200px.
  expect(экран.открыт.ширина > 0 && экран.открыт.ширина <= 560 && экран.открыт.ширина >= 520,
    '⚠️ ЭКРАН ТАБЛИЦЫ: ширина не больше 560 и на широком экране достигает его (' +
    экран.открыт.ширина + 'px)');
