...
`;
  ...
  // хотя выбеливание владельца шло именно по второй.
  {
    ...
    expect(отм === 1 && нажато && реестр.join() === 'animal'
        ...
        && предБи && предБи.n > 500 && котДо && котДо.n > 500 && котПосле,
    ...
    expect(Math.abs(примБи.я - предБи.я) > 5,
      ...
      'из `setPackMatcap` (10-stage) цикл по `thumbItemsOfPack`: замер замрёт на ' +
      '135.0/0.418, а все прочие стражи раздела останутся зелёными');
