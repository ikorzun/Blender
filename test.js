...
(async () => {
  ...
  console.log('finale cleanup: alive', fin2.alive, '| win:', fin2.win, '| score (expect 150, золотая рыбка):', fin2.score,
  ...
  console.log('difficulty: easy acc==alive-1 (рыбка закопана):', diff.easy.acc === diff.easy.alive - 1,
