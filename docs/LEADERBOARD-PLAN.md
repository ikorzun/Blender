...
Прогон на настоящем борде `Blendo` с твоим токеном, 2026-07-29:
...
| **в)** Отправлять не баланс, а другую величину | — | Не решает: при хранении максимума ЛЮБАЯ величина будет показывать пик |
...
⚠️ **В таблице осталась тестовая строка** — 90000 под именем «Lavender Leech».
Удалить её из игры нечем (в SDK нет такого метода), но борд можно пересоздать
в кабинете.
