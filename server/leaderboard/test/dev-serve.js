    ...
    if (u.pathname.startsWith('/_dev/')) {
      ...
      try {
        ...
        if (u.pathname === '/_dev/rewind') {
          ...
          //   2) ВОЗРАСТНОЙ ПОТОЛОК — он меряет возраст СТРОКИ. Свежей
          //      разрешено `GROW_BASE` (2000), и потолок растёт на
          //      `GROW_PER_S` в секунду; отправка сверх него СКРЫВАЕТ строку
